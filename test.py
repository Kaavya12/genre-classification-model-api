...
# data = {'y': y.tolist(), 'sr': sr}
# print(data)
# json_object = json.dumps(data)  
# print(json_object)

interpreter = tf.lite.Interpreter(model_path="/Users/kaavyamahajan/dev/src/github/model_api/models/model_v2.tflite")
input_details = interpreter.get_input_details()
output_details = interpreter.get_output_details()
interpreter.allocate_tensors()
pipe = joblib.load("/Users/kaavyamahajan/dev/src/github/model_api/models/pipe_10.joblib") 
enc = joblib.load("/Users/kaavyamahajan/dev/src/github/model_api/models/enc_10.jobilb")
